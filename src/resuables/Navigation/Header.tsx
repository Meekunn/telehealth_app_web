		...
		<Box>
			...
			<Flex bg="#48BB78" alignItems="center" py={0}>
				...
				<Box textAlign="center" width="100%">
					<Box as="button" onClick={() => setActive('courseOutline')} display="block" width="100%">
						<Flex gap="2" justifyContent="left" alignItems="center" width="100%" py="4" px="10">
							<FaBook color="white" />
							<Heading as="h4" color="white" fontWeight="400" fontFamily="Arial" fontSize={['md', 'lg', 'xl']}>
								Course Outline
							</Heading>
						</Flex>
					</Box>
					{/* Render the green bar under the box */}
					{active === 'courseOutline' && <Box bg="green.300" height="4px" mt={2} width="100%" borderRadius="md" />}
				</Box>
			</Flex>
		</Box>
	);
